...
add_action('init', function(){
    ...
    add_shortcode(
        'gmuw_gmuwptheme_shortcode', //shortcode label (use as the shortcode on the site)
        'gmuw_gmuwptheme_shortcode' //callback function
    );
...
function gmuw_gmuwptheme_shortcode(){
