...
add_action('admin_enqueue_scripts', function(){
  ...
  wp_enqueue_script(
    'gmuw_gmuwptheme_admin_datatables_js', //script name
    plugin_dir_url( __DIR__ ).'datatables/datatables.min.js' //path to script
  );

  // Enqueue the custom admin javascript
  wp_enqueue_script(
    'gmuw_gmuwptheme_admin_custom_js', //script name
    plugin_dir_url( __DIR__ ).'js/custom-gmuwptheme-admin.js', //path to script
